        ...
        4088: function(e, t, r) {
            ...
            let I = (0, c.ZP)("header", {
                ...
                L = e => {
                    ...
                    return t.name && t.name.length > 0 ? (0, n.jsxs)(R, {
                        children: [(0, n.jsx)(Z, {
                            children: (0, n.jsx)(w, {
                                address: t.name,
                                size: "regular"
            ...
            let V = (0, c.ZP)(j.D, {
                ...
                _ = e => {
                    let {
                        bannerIsActive: t
                    } = e, r = (0, g.Z)(), [o, i] = (0, s.useState)(!1), [l, a] = (0, s.useState)(!0), {
                        scrollDirection: c,
                        scrollY: d
                    } = h();
                    return (0, s.useEffect)(() => {
                        (0, f.Z)() && d < 60 ? a(!0) : (!r || r && d > 60) && a("down" === c)
                    }, [c, d]), (0, n.jsx)(I, {
                        hidden: !l,
                        children: (0, n.jsxs)(M, {
                            children: [(0, n.jsxs)(P, {
            ...
            let x = i.default.forwardRef(function(e, t) {
                ...
                let C = !1 !== b,
                    ...
                    z = !P,
                    {
                        ...
                        let [e, t] = l.resolveHref(P, a, !0);
                        return {
                            href: e,
                            as: f ? l.resolveHref(P, f) : t || e
                        }
                    }, [P, a, f]),
                    W = i.default.useRef($),
                    D = i.default.useRef(H);
                M && (n = i.default.Children.only(r));
                let T = M ? n && "object" == typeof n && n.ref : t,
                    [Z, L, O] = p.useIntersection({
                        rootMargin: "200px"
                    }),
                    V = i.default.useCallback(e => {
                        (D.current !== H || W.current !== $) && (O(), D.current = H, W.current = $), Z(e), T && ("function" == typeof T ? T(e) : "object" == typeof T && (T.current = e))
                    }, [H, T, $, O, Z]);
                i.default.useEffect(() => {
                    E && L && C && g(E, $, H, {
                        locale: k
                    })
                }, [H, $, L, k, C, null == P ? void 0 : P.locale, E]);
                let N = {
                    ref: V,
                    onClick(e) {
                ...
                if (!M || A || "a" === n.type && !("href" in n.props)) {
                    let e = void 0 !== k ? k : null == P ? void 0 : P.locale,
                        t = (null == P ? void 0 : P.isLocaleDomain) && u.getDomainLocale(H, e, null == P ? void 0 : P.locales, null == P ? void 0 : P.domainLocales);
                    N.href = t || h.addBasePath(s.addLocale(H, e, null == P ? void 0 : P.defaultLocale))
                }
        ...
        6794: function(e, t, r) {
            ...
            var n, o = r(2784),
                ...
                Y = (e, t) => G(e, () => (r, n) => {
                    ...
                    let o = `.${r=(r="string"==typeof r?r:"")||`${k(e.prefix)}t-${R(n)}`}`,
                        i = {},
                        l = [];
                    for (let t in n)
